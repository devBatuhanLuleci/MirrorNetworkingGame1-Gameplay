...
class GridSystemCameraController : MonoBehaviour
{
    #region IOSAndroid
    ...
    private void Update()
    {
        ...
        if (Input.touchCount >= 1)
        {
            ...
            {
                if (GridManager.instance.inputState != GridManager.InputState.Dragging)
                {
        ...
        if (Input.touchCount >= 1)
        {
            ...
            if (Input.GetTouch(0).phase == TouchPhase.Ended)
            {
                ...
                if (GridManager.instance.inputState != GridManager.InputState.Idle)
                {
                    GridManager.instance.inputState = GridManager.InputState.Idle;
                }
